...
module.exports = (script, params, opts) => {
  ...
  args.push('--config-in', params.configIn);
  args.push('--config-out', params.configOut);
  args.push('--min-power', params.minPower);
  args.push('--max-powern', params.maxPower);
  args.push('--max-gpu-oc', params.maxGpuOc);
  args.push('--max-mem-oc', params.maxMemOc);
  args.push('--min-fan-speed', params.minFanSpeed);
  args.push('--max-fan-speed', params.maxFanSpeed);
  args.push('--rate-limit', params.rateLimit);
